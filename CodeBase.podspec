#
#  Be sure to run `pod spec lint CodeBase.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/leeqb/CodeBase"
  ...
  s.source       = { :git => "https://github.com/leeqb/CodeBase.git", :tag => "1.0.0" }
  ...
  # s.resource  = "icon.png"
  s.resources = "CodeBase/Resources/*"
  ...
  s.dependency 'SDWebImage' #图片缓存
  s.dependency 'pop' #facebook 动画框架
  s.dependency 'ObjectiveSugar' #包含一些扩展类，方便编码
  s.dependency 'UMengAnalytics-NO-IDFA' #友盟
  s.dependency 'Masonry' #自动布局
  s.dependency 'SDCycleScrollView' #循环滚动
  s.dependency 'MJRefresh' #分页处理
  s.dependency 'JSBadgeView' #徽章
